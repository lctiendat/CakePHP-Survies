                    ...
                    <div class="col-md-6 col-lg-6">
                        <article>
                            ...
                            <div class="post_text">
                                ...
                                <h5 class="post_title">
                                    <a href="/category/<?= $survy->category_id ?>/question/<?= $survy->id ?>"><?= $survy->question ?>
                                    </a>
                                </h5>
                    ...
                    foreach ($topposts as $toppost) { ?>
                        <li class="media">
                            ...
                            <div class="media-body">
                                <a href="/category/<?= $survy->category_id ?>/question/<?= $toppost->id ?>" class="media-title"><?= $toppost->question ?></a>
                                <div class="post_meta_top">
                                    <span class="post_meta_category">
                                        <a href="blog-standard-two-col-right-sidebar.html">FOOD, TRAVEL</a>
                                    </span>
